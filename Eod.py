...
class Eodhistoricaldata:
    def __init__(self):
        ...
        self.__URL_BUILD = {
            ...
            "market_info_URL": r"https://eodhistoricaldata.com/api/eod/MCD.US?from=2017-01-05&to=2017-02-10&period=d&fmt=json&api_token={Enter token}",
            "CSV_URL": 'https://eodhistoricaldata.com/api/eod/MCD.US?api_token={Enter token}'
        }
